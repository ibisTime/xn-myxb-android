...
public class WxUtil {
    ...
    public static final String APPID = "wx5ffb402a56672a03";
...
//        req.transaction = buildTransaction("图文链接");
     ...
     * @return
     */
    public static void pay(Context context, WxAliPayRequestModel model) {
        ...
        req.packageValue = model.getWechatPackage();
