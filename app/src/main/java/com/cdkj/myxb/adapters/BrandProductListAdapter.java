...
public class BrandProductListAdapter extends BaseQuickAdapter<BrandProductModel, BaseViewHolder> {


    public BrandProductListAdapter(@Nullable List<BrandProductModel> data) {
        super(R.layout.item_brand_product_list, data);
    }
