...
public class CommentListAdapter extends BaseQuickAdapter<CommentListMode, BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder helper, CommentListMode item) {
        ...
        ImgUtils.loadQiniuLogo(mContext, item.getCommentUser().getPhoto(), helper.getView(R.id.img_comment));

        helper.setText(R.id.tv_comment_name, item.getCommentUser().getRealName());
