...
import com.cdkj.myxb.databinding.ItemUserAtlasTBinding;
...
public class UserAtlasTypeTAdapter2 extends BaseQuickAdapter<AtlasModel, BaseViewHolder> {


    public UserAtlasTypeTAdapter2(@Nullable List<AtlasModel> data) {
        super(R.layout.item_user_atlas_t, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, AtlasModel item) {
        ItemUserAtlasTBinding mBinding = DataBindingUtil.bind(helper.itemView);
        ...
        ((DefaultItemAnimator) mBinding.rvJxs.getItemAnimator()).setSupportsChangeAnimations(false);
