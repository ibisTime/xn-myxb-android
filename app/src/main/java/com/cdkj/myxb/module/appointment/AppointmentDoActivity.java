...
public class AppointmentDoActivity extends AbsBaseLoadActivity {
    ...
    private void showDoDialog() {
        ...
        } else if (TextUtils.equals(OrderHelper.APPOINTMENT_1, mState)) {//下课
            showDoubleWarnListen("确认接单？", view -> {
                finish();
            }, view -> {
                sureOrder();
            });
    ...
    public void sureOrder(){
        ...
        Call call = RetrofitUtils.getBaseAPiService().successRequest("805511", StringUtils.getJsonToString(map));
