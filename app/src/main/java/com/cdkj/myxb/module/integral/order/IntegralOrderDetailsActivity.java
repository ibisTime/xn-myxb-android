...
public class IntegralOrderDetailsActivity extends AbsBaseLoadActivity {
    ...
    private void setShowData(IntegralOrderListModel data) {
        ...
        mBinding.headerLayout.llRoot.setVisibility(View.VISIBLE);

        ImgUtils.loadQiniuImg(this, data.getProductPic(), mBinding.headerLayout.imgPic);

        //订单信息
        mBinding.headerLayout.tvName.setText(data.getProductName());
        mBinding.headerLayout.tvInfo.setText(data.getProductSlogan());
