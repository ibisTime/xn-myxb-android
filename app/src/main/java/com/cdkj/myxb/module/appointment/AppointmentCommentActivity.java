...
public class AppointmentCommentActivity extends AbsBaseLoadActivity {
     ...
     */
    public static void open(Context context, String orderCode, String type, String owner) {
        if (context == null) {
            return;
        }
    ...
    public void releaseRequest() {
        ...
        map.put("entityCode", owner);
        map.put("type", mType);/*Lecturer("L", "讲师"), Specialist("S", "专家"), Tutor("T", "服务团队"), PRODUCT("P", "产品"), IP：积分商品*/
